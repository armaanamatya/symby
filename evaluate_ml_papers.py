"""
Evaluate all ML papers and save each as individual JSON file
"""
...
def evaluate_all_ml_papers(
    input_file: str = "Symby_AI/modded_s2orc_ml.jsonl",
    output_dir: str = "ml_evaluations",
    batch_size: int = 100
):
    """
    Evaluate all ML papers and save each as individual JSON file.
    ...
    Args:
        input_file: Path to ML JSONL file
    ...
    print("="*60)
    print("EVALUATING ALL ML PAPERS")
    print("="*60)
...
if __name__ == "__main__":
    # Run evaluation
    summary = evaluate_all_ml_papers(
        input_file="Symby_AI/modded_s2orc_ml.jsonl",
        output_dir="ml_evaluations"
    )

    print("\n✅ All ML papers evaluated and saved!")
